      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Body className="font-sans">
          ...
          <div className="text-lg">
            이 설정을 켜면 <span className="font-semibold">즐겨찾기한 키워드</span>와{' '}
            <span className="font-semibold">종목</span>에 대한 <span className="font-semibold">순위 알림</span>을 받을
            수 있어요
          </div>
          ...
          {isSwitchOn && (
            <>
              ...
              <div className="text-lg font-semibold">알림을 받을 키워드를 선택해주세요</div>
              <div>
              ...
              <div className="text-lg font-semibold">알림을 받을 종목을 선택해주세요</div>
              <div>
                {stockList?.length > 0 ? (
